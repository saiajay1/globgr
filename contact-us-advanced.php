...
<html>
	<head>
		...
		<!-- Basic -->
		<meta charset="utf-8">
		<title>Contact Us Advanced | GLOBAL GROUP </title>		
		...
		<div class="body">
			<header id="header">
				<div class="container">
					<div class="logo">
						<a href="index.html">
							<img alt="Porto" width="111" height="54" data-sticky-width="190" data-sticky-height="150" src="img/logo.png">
						</a>
					</div>
					<div class="search">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<ul class="list-unstyled">
								...
								<li><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:info@globalgrp.co.uk">info@globalgrp.co.uk</a></li>
							</ul>
						...
						<div class="col-md-4">
							<div class="contact-details">
								...
								<ul class="contact">
									...
									<li><p><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:info@globalgrp.co.uk">info@globalgrp.co.uk</a></p></li>
								</ul>
							</div>
						</div>
						<div class="col-md-2">
				...
				<div class="footer-copyright">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-7">
								<p>© 2021 GLOBAL GROUP. All rights reserved | Design by AJAY</p>
							</div>
							<div class="col-md-4">
								<nav id="sub-menu">
									<ul>
